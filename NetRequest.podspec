...
Pod::Spec.new do |s|
  s.name             = 'NetRequest'
  s.version          = '0.1.0'
  s.summary          = 'A short description of NetRequest.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/NetRequest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Gabriel Villarreal' => 'gabriel@paybook.me' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/NetRequest.git', :tag => s.version.to_s }
